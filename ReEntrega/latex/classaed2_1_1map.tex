...
\item[\hyperlink{bug__bug000013}{Bug}]Este R\+EP es ilegible, intenten formatearlo mejor o subdividir en más suboperaciones\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000014}{Bug}]Hace falta decir lo de cant de claves?\end{DoxyRefDesc}
}\begin{DoxyCompactItemize}
\item 
...
Definición en la línea \hyperlink{map_8h_source_l01122}{1122} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
\end{DoxyPostcond}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000002}{Bug}]Idem antes, \char`\"{}it.\+n-\/$>$color == Color\+::\+Header\char`\"{}, es mejor usar funciones\+: son más declarativas y ayuda a que cambios futuros de estructura no afecten a todo el código\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000003}{Bug}]En la post deben decir algo más sobre el iterator res, en particular algun otro de los observadores del iterador\end{DoxyRefDesc}


\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000004}{Bug}]Este código se puede mejorar, pero está bien\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000005}{Bug}]No pueden llamar a funciones const desde funciones no const, no lo vuelvo a mencionar pero se repite mucho este error \end{DoxyRefDesc}


Definición en la línea \hyperlink{map_8h_source_l01256}{1256} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
\end{DoxyPostcond}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000006}{Bug}]not lt(it.\+n-\/$>$key(), key) and not lt(key, it.\+n-\/$>$key()) usen funciones\end{DoxyRefDesc}
...
Definición en la línea \hyperlink{map_8h_source_l01369}{1369} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000007}{Bug}]Digan algo en la P\+RE (y aliasing) sobre el iterador hint, que debe cumplir 
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000008}{Bug}]hint++; Esto esta dentro del if donde hint es el header \end{DoxyRefDesc}
...
Definición en la línea \hyperlink{map_8h_source_l01417}{1417} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l01448}{1448} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
\end{DoxyPostcond}
\begin{DoxyRefDesc}{Obsoleto}
\item[\hyperlink{deprecated__deprecated000007}{Obsoleto}]$ definir(\PI1 value, \PI2 value), self) $ las \char`\"{}variables\char`\"{} de los T\+A\+DS no se modifican\end{DoxyRefDesc}


\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000009}{Bug}]El find del principio les arruina la complejidad ante un buen hint\end{DoxyRefDesc}
...
\end{DoxyPostcond}
\begin{DoxyRefDesc}{Obsoleto}
\item[\hyperlink{deprecated__deprecated000008}{Obsoleto}]No dicen nada sobre res\end{DoxyRefDesc}


\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000010}{Bug}]Intenten no repetir código (iterator(const\+\_\+cast$<$\+Node$\ast$$>$(pos0.\+n));), idem \hyperlink{classaed2_1_1map_a6941cde9a79c27f054b5c97a587a1854_a6941cde9a79c27f054b5c97a587a1854}{aed2\+::map\+::insert} 
...
Definición en la línea \hyperlink{map_8h_source_l01528}{1528} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
\end{DoxyPostcond}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000011}{Bug}]Mejor\+: \hyperlink{classaed2_1_1map_1_1const__iterator}{const\+\_\+iterator} pos (find(key)); o\+: \hyperlink{classaed2_1_1map_1_1const__iterator}{const\+\_\+iterator} pos = find(key); Ambas funcionan y son más claras.\end{DoxyRefDesc}
...
\end{DoxyPostcond}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000012}{Bug}]Es verdaderamente necesario el primer if??\end{DoxyRefDesc}
...
Definición en la línea \hyperlink{map_8h_source_l01603}{1603} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l01675}{1675} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l01756}{1756} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000015}{Bug}]Suena a que les vendría bien una operación que te diga si un nodo es hijo derecho o izquierdo de su padre Donde la pondrían??\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000016}{Bug}]Si en los nodos 0 es left y 1 right, por que lo cambian\end{DoxyRefDesc}
...
Definición en la línea \hyperlink{map_8h_source_l02651}{2651} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02679}{2679} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02716}{2716} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02733}{2733} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02748}{2748} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02805}{2805} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02835}{2835} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02846}{2846} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02857}{2857} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02868}{2868} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l02480}{2480} del archivo \hyperlink{map_8h_source}{map.\+h}.
