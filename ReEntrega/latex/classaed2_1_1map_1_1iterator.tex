...
Definición en la línea \hyperlink{map_8h_source_l01817}{1817} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
\item[\hyperlink{deprecated__deprecated000009}{Obsoleto}]Su pre es muy fuerte y su P\+O\+ST muy débil\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Obsoleto}
\item[\hyperlink{deprecated__deprecated000010}{Obsoleto}]Imaginense que en un par de años cambian la estructura interna de iterator, teniendo que cambiar la igualda, como esta hecho ahora deberían cambiar dos funciones\end{DoxyRefDesc}
