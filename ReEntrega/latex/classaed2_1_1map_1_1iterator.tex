...
\item[\hyperlink{bug__bug000024}{Bug}]No sigue la especifición, si algo se debería romper es mejor que se rompa 
...
\end{DoxyPostcond}
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000025}{Bug}]Su pre es muy fuerte y su P\+O\+ST muy débil\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000026}{Bug}]Imaginense que en un par de años cambian la estructura interna de iterator, teniendo que cambiar la igualda, como esta hecho ahora deberían cambiar dos funciones\end{DoxyRefDesc}
...
Definición en la línea \hyperlink{map_8h_source_l02132}{2132} del archivo \hyperlink{map_8h_source}{map.\+h}.
