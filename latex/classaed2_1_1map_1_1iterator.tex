...
rep\+\_\+iter(n) $\equiv$ true $\Leftrightarrow$ (( $\exists$ k \+: nat) nothing?(padre\+K(p , k).value) $\land_{\rm L}$ es\+R\+B-\/\+Tree(padre\+K(p , k))
...
abs\+\_\+iter(n) $\equiv$ $=_{\rm obs}$ ( $\forall$ b\+:i\+Tbi(d,value\+\_\+type)) $\vert$ anteriores(b) = Anteriores\+De(inorder(Arbol\+Value(\&header(p))),data($\ast$p).value) $\land$ siguientes(b) = siguientes\+De(inorder(Arbol\+Value(\&header(p))),data($\ast$p).value)
...
Definición en la línea \hyperlink{map_8h_source_l01731}{1731} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l01735}{1735} del archivo \hyperlink{map_8h_source}{map.\+h}.
...
Definición en la línea \hyperlink{map_8h_source_l01798}{1798} del archivo \hyperlink{map_8h_source}{map.\+h}.
